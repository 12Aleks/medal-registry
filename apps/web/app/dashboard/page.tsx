...
const DashboardPage = async ({}) => {
        ...
        const recentSoldiers = [
                ...
                { id: '3', name: 'Cpt. Sarah Connor', rank: 'Captain', conflictsCount: 3, medalsCount: 5, addedAt: '3 days ago' },
        ];
        return (
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Soldiers Added</span>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Medals Linked</span>
                ...
                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Conflicts Linked</span>
                        ...
                        <div className="flex items-baseline justify-between mt-3">
                                ...
                                <span className="text-xs font-medium text-slate-500 bg-slate-100 px-2 py-0.5 rounded-full">Campaigns</span>
                        </div>
                </div>

                <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm hover:shadow-md transition-shadow">
                        <div className="flex items-center justify-between">
                                <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Contributor Rank</span>
                            ...
                            <div className="lg:col-span-2 bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
                                    ...
                                    <div className="divide-y divide-slate-100">
                                            {recentSoldiers.map((soldier) => (
                                                <div key={soldier.id} className="p-4 px-6 hover:bg-slate-50 transition-colors flex items-center justify-between">
                  ...
                  <span className="inline-flex items-center text-xs text-slate-600 bg-slate-100 px-2 py-1 rounded">
                    📜 {soldier.conflictsCount} conflicts
                                                                ...
                                                                <span className="inline-flex items-center text-xs text-amber-700 bg-amber-50 border border-amber-200 px-2 py-1 rounded">
                    ...
                    {soldier.addedAt}
                            ...
                            <div className="bg-slate-950 text-white border border-slate-900 rounded-xl p-6 shadow-sm flex flex-col justify-between min-h-[220px]">
                                    <div className="space-y-2">
                                            ...
                                            <p className="text-slate-400 text-xs leading-relaxed">
                                                    Do you know a veteran or an ancestor who served? Add their record, link their medals, and preserve history.
                                            </p>
                                    </div>
                                    <button className="w-full mt-4 bg-white text-slate-950 font-semibold text-sm py-2.5 px-4 rounded-lg hover:bg-slate-100 transition-colors cursor-pointer text-center shadow-sm">
                                            + Add New Soldier
                                    </button>
                            </div>
